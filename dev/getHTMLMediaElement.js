...
function getAudioElement(mediaElement, config) {
    ...
    // stop.style['border-top-right-radius'] = '2px';
    // stop.style['border-bottom-right-radius'] = '2px';
    ...
    // h2.setAttribute('style', 'position: absolute;color: rgb(160, 160, 160);font-size: 2px;text-shadow: 1px 1px rgb(255, 255, 255);padding:0;margin:0;');
    mediaBox.appendChild(h2);

    mediaBox.appendChild(mediaElement);

    mediaElementContainer.style.width = '0px';
    mediaBox.style.height = '0px';
